function [TradSleepOnset, SleepOnset, OnsetSpeed, WakeExponent, N3Exponent, Trend, TimeOnset, Exponents] = ...
    detect_sleep_onset(Scoring, Exponents, Time, MinEpochs, SmoothExponents)
...
error('old script. use detect.sleep_onset()')
...
[SleepOnset, OnsetSpeed, WakeExponent, N3Exponent, Trend, TimeOnset, Exponents] = ...
